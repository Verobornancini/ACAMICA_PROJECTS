...
Listado.prototype.buscarRestaurante = function(id) {
    var restauranteEncontrado= this.restaurantes.find(function(restaurante){
...
Listado.prototype.sinRepetidos = function(arreglo){
    arreglo.filter(function(elem, index, self){
...
Listado.prototype.obtenerUbicaciones = function() {
    var ciudades= this.ubicacion.map(()=>{
        sinRepetidos(ciudades);
        }
    );
};

//Obtiene todos los rubros de los restaurantes sin repetidos
Listado.prototype.obtenerRubros = function() {
    var rubros = this.rubro.map(()=>{
        sinRepetidos(rubros);
        }
    );
};
...
Listado.prototype.obtenerHorarios = function() {
    var arregloDeHorarios= this.horarios.map(()=>{
        sinRepetidos(arregloDeHorarios);
        }
    );
};
...
//Se crea el listado de restaurantes de la aplicación
