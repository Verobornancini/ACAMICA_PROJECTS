...
//Cuando hablamos de dibujar, nos referimos a crear Los elementos HTML que permiten visualizar el restaurante.
Aplicacion.prototype.dibujarListado = function(restaurantes) {
    ...
    //Si no se recibe ningún restaurante por parámetro (porque los filtros aplicados no retornaron ningún resultado)
    // se crea un elemento que va a mostrar en el HTML el mensaje de "No se encontraron resultados".
...
Aplicacion.prototype.crearTarjetaDeRestaurante = function(restaurant) {
    ...
    //Buscamos el elemento que se corresponde con la puntuación y le registramos al evento click, 
    //la funcionalidad de calificar un restaurant
    ...
    //Por cada horario de un restaurante, creamos el elemento HTML que va a mostrarlo. 
    //Además le asignamos la funcionalidad de reservar un restaurante.
...
//La alerta que se utilizó es de la biblioteca "SweetAlert".
//En el caso de que la calificación sea válida, se ejecuta la función de calificarRestaurant() del listado. 
//Luego, se busca en el HTML el restaurante que se corresponde con el id que se está calificando y se le actualiza la puntuación
